...
import com.arcieri.wagner.mvvm_recipebook.ui.screen.main.components.main_menu_content.main_menu_buttons.UnitsConverterAlertDialog
import com.arcieri.wagner.mvvm_recipebook.ui.theme.*
import kotlinx.coroutines.launch

@Composable
fun MainMenuButtons(catalogViewModel: CatalogViewModel) {
...
//            TODO make API / DTOs to import recipes
    ...
    MainMenuButton(
        ...
        fontColor = RB_White,
        onClick = { coroutineScope.launch { isUnitConverterOpen.value = true } }
    )
